...
public class AutoPoses {
    ...
    public static Pose intakeMeioPose        = new Pose(16, 59, Math.toRadians(0));
    ...
    public static Pose shootPose1            = new Pose(63, 80, Math.toRadians(0));
    ...
    public static Pose intakeBaixoPose       = new Pose(15, 35, Math.toRadians(0));
    ...
    public static Pose goalPoseVermelho            = new Pose(10, 137, Math.toRadians(0));
