...
public class AutoPoses {
    ...
    public static Pose intakeMeioPose        = new Pose(22, 59.49504304316747, Math.toRadians(0));
    public static Pose gatePose              = new Pose(14, 58, Math.toRadians(0));
    public static Pose gatePose2             = new Pose(12.44, 57, Math.toRadians(0));
    public static Pose gateCurvedPose        = new Pose(57.8356590111, 48, Math.toRadians(0));
    ...
    public static Pose intakeCimaPose        = new Pose(23, 84, Math.toRadians(0));
