...
public class AutoPoses {
    public static Pose poseInicial       = new Pose(23, 121, Math.toRadians(90));
    public static Pose intakeCurvedPose  = new Pose(80, 50, Math.toRadians(0));
    public static Pose intakePose        = new Pose(25, 55, Math.toRadians(0));
    public static Pose shootPose1        = new Pose(56.726, 75.225, Math.toRadians(0));
    public static Pose intakeGatePose    = new Pose(11.820, 59.5, Math.toRadians(0));
